...
`CONTRIBUTING.md` is framed around "before submitting a PR". For agents, the equivalent gate is **before reporting any code task as complete**: run the four CI checks and the self-review checklist there, even when the user will be the one to submit the PR.
